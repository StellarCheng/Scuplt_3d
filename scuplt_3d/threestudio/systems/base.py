...
class BaseLift3DSystem(BaseSystem):
    ...
    def configure(self) -> None:
        ...
        self.renderer = threestudio.find(self.cfg.renderer_type)(  #'nerf-volume-renderer'
            self.cfg.renderer,  #{'radius': 1.0, 'num_samples_per_ray': 512}
            geometry=self.geometry,  #ImplicitVolume
            material=self.material,
            background=self.background,  #NeuralEnvironmentMapBackground
        )
        #p.set_trace()
